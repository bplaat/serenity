    ...
    , m_preferred_color_scheme(preferred_color_scheme)
{
    ...
    on_scroll_by_delta = [this](auto delta_x, auto delta_y) {
        outln("on_scroll_by_delta {} {}", delta_x, delta_y);
...
void WebViewBridge::set_viewport_rect(Web::DevicePixelRect viewport_rect, ForResize for_resize)
{
...
void WebViewBridge::mouse_down_event(Web::DevicePixelPoint position, Web::DevicePixelPoint screen_position, GUI::MouseButton button, KeyModifier modifiers)
{
    client().async_mouse_down(position, screen_position, to_underlying(button), to_underlying(button), modifiers);
}

void WebViewBridge::mouse_up_event(Web::DevicePixelPoint position, Web::DevicePixelPoint screen_position, GUI::MouseButton button, KeyModifier modifiers)
{
    client().async_mouse_up(position, screen_position, to_underlying(button), to_underlying(button), modifiers);
}

void WebViewBridge::mouse_move_event(Web::DevicePixelPoint position, Web::DevicePixelPoint screen_position, GUI::MouseButton button, KeyModifier modifiers)
{
    client().async_mouse_move(position, screen_position, 0, to_underlying(button), modifiers);
}

void WebViewBridge::mouse_wheel_event(Web::DevicePixelPoint position, Web::DevicePixelPoint screen_position, GUI::MouseButton button, KeyModifier modifiers, Web::DevicePixels wheel_delta_x, Web::DevicePixels wheel_delta_y)
{
    client().async_mouse_wheel(position, screen_position, to_underlying(button), to_underlying(button), modifiers, wheel_delta_x, wheel_delta_y);
}

void WebViewBridge::mouse_double_click_event(Web::DevicePixelPoint position, Web::DevicePixelPoint screen_position, GUI::MouseButton button, KeyModifier modifiers)
{
    client().async_doubleclick(position, screen_position, button, to_underlying(button), modifiers);
}
