...
MailWidget::MailWidget()
{
    ...
    m_web_view->on_link_context_menu_request = [this](Web::DevicePixelPoint position, auto& url) {
    ...
    m_web_view->on_image_context_menu_request = [this](Web::DevicePixelPoint position, auto& image_url, Gfx::ShareableBitmap const& shareable_bitmap) {
