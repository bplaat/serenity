...
ErrorOr<void> MainWidget::setup()
{
    ...
    m_bell_mode = VT::TerminalWidget::parse_bell(Config::read_string("Terminal"sv, "Window"sv, "Bell"sv)).value_or(Terminal::default_bell_mode);
    m_original_bell_mode = m_bell_mode;

    m_automark_mode = VT::TerminalWidget::parse_automark_mode(Config::read_string("Terminal"sv, "Terminal"sv, "AutoMark"sv)).value_or(Terminal::default_automark_mode);
    ...
    case VT::TerminalWidget::BellMode::AudibleBeep:
        m_beep_bell_radio->set_checked(true, GUI::AllowCallback::No);
        break;
    case VT::TerminalWidget::BellMode::Disabled:
        m_no_bell_radio->set_checked(true, GUI::AllowCallback::No);
        break;
    }
    ...
    case VT::TerminalWidget::AutoMarkMode::MarkNothing:
        m_automark_off_radio->set_checked(true, GUI::AllowCallback::No);
        break;
    ...
    m_confirm_close = Config::read_bool("Terminal"sv, "Terminal"sv, "ConfirmClose"sv, Terminal::default_confirm_close);
...
{
    m_bell_mode = Terminal::default_bell_mode;
    m_automark_mode = Terminal::default_automark_mode;
    m_confirm_close = Terminal::default_confirm_close;
