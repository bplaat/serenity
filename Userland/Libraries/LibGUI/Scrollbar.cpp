...
void Scrollbar::paint_event(PaintEvent& event)
{
    ...
    Gfx::ScrollbarState state {
        .dec_pressed = (m_pressed_component == Component::DecrementButton) && (m_pressed_component == m_hovered_component) && !is_min(),
        .dec_hovered = hovered_component_for_painting == Component::DecrementButton,
        .inc_pressed = (m_pressed_component == Component::IncrementButton) && (m_pressed_component == m_hovered_component) && !is_max(),
        .inc_hovered = hovered_component_for_painting == Component::IncrementButton,
